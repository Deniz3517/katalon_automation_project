...
WebUI.doubleClick(findTestObject('Object Repository/Page_Automation Exercise/div_AutomationExerciseFull-Fledged practice_cc0a5c'))
...
WebUI.click(findTestObject('Object Repository/Page_Automation Exercise/button_Consent'))
